    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <section className="flex flex-col md:flex-row items-center md:items-start py-12">
                <div className="md:w-1/2 text-center md:text-left bg-emerald-600 p-8 text-white">
                    ...
                    <button className="bg-teal-500 text-white py-2 px-6 rounded hover:bg-blue-600">
                        View Collection
                    </button>
                </div>
